...
const prisma_1 = require("../src/app/config/prisma");
const seedBills = async () => {
    ...
    if (!customer) {
        throw new Error("No active CUSTOMER found. Register a customer first.");
    }
    ...
    const result = await prisma_1.prisma.bill.createMany({
        data: bills,
        skipDuplicates: true,
    });
