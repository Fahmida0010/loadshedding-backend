...
const createOutage = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await OutageService.createOutage(reportedById, req.body);
...
const getAllOutages = catchAsync(async (req: Request, res: Response) => {
	const result = await OutageService.getAllOutages(req.query as IOutageQuery);
...
const getMyOutages = catchAsync(async (req: Request, res: Response) => {
	const reportedById = req.user!.userId;

	const result = await OutageService.getMyOutages(
		reportedById,
...
const updateOutage = catchAsync(async (req: Request, res: Response) => {
	const result = await OutageService.updateOutage(req.params.id, req.body);
...
const deleteOutage = catchAsync(async (req: Request, res: Response) => {
	await OutageService.deleteOutage(req.params.id);
