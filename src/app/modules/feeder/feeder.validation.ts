...
const createFeederValidationSchema = z.object({
  body: z.object({
    ...
    name: z
      ...
      .min(
        2,
        "Feeder name must contain at least 2 characters",
      )
      .max(
        100,
        "Feeder name cannot exceed 100 characters",
      ),
    ...
    code: z
      ...
      .min(
        2,
        "Feeder code must contain at least 2 characters",
      )
      .max(
        30,
        "Feeder code cannot exceed 30 characters",
      )
