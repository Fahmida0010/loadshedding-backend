...
const getAllFeeders = catchAsync(async (req: Request, res: Response) => {
	const query: IFeederQuery = {
		...
		priority:
			typeof req.query.priority === "string"
				? (req.query.priority as IFeederQuery["priority"])
				: undefined,
	...
	const result = await FeederService.getAllFeeders(query);
...
const getFeederById = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await FeederService.getFeederById(id);
...
const updateFeeder = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await FeederService.updateFeeder(id, req.body);
...
const deleteFeeder = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await FeederService.deleteFeeder(id);
