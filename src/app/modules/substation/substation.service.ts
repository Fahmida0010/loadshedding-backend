...
const createSubstation = async (payload: ICreateSubstation) => {
	...
	if (existingCode) {
		throw new AppError(409, "A substation with this code already exists");
	}
...
const getAllSubstations = async (query: ISubstationQuery) => {
...
const updateSubstation = async (id: string, payload: IUpdateSubstation) => {
