...
const createDistributionZoneValidationSchema = z.object({
	body: z.object({
		name: z
			.string({
...
const updateDistributionZoneValidationSchema = z.object({
	body: z
		.object({
			name: z
				.string()
...
const distributionZoneIdValidationSchema = z.object({
	params: z.object({
