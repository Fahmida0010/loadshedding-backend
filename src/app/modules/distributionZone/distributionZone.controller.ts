...
const createDistributionZone = catchAsync(
	async (req: Request, res: Response) => {
		const result = await DistributionZoneService.createDistributionZone(
...
const getAllDistributionZones = catchAsync(
	async (req: Request, res: Response) => {
		const result = await DistributionZoneService.getAllDistributionZones(
...
const getDistributionZoneById = catchAsync(
	async (req: Request, res: Response) => {
		const result = await DistributionZoneService.getDistributionZoneById(
			req.params.id,
		);
...
const updateDistributionZone = catchAsync(
	async (req: Request, res: Response) => {
		const result = await DistributionZoneService.updateDistributionZone(
			req.params.id,
...
const deleteDistributionZone = catchAsync(
	async (req: Request, res: Response) => {
		const result = await DistributionZoneService.deleteDistributionZone(
			req.params.id,
		);
