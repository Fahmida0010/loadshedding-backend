...
const getAllAreas = catchAsync(async (req: Request, res: Response) => {
	const query: IAreaQuery = {
		...
		feederId:
			typeof req.query.feederId === "string" ? req.query.feederId : undefined,

		priority:
			typeof req.query.priority === "string"
				? (req.query.priority as IAreaQuery["priority"])
				: undefined,
	...
	const result = await AreaService.getAllAreas(query);
